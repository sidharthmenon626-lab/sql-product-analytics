...
| S5 | `s5_expansion_revenue.sql` | saas | Who's expanding MRR, and how? | **70%** of 6-month expansion MRR is plan upgrades (median 417 days to happen); total drifts over time vs. S1 since S5 uses `current_date`, not a fixed window |
